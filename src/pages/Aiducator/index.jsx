      ...
      <Suspense fallback={<LoadingScreen />}>
        ...
        <section className={styles.secondSection}>
          ...
          <FadeUpEffect tag="p">
            ...
            educational institutions, AiDucator harnesses the power of advanced
            AI to deliver personalized, real-time support—while keeping the
            human touch at its core. Say goodbye to the frustrations of
        ...
        <section className={styles.thirdSection}>
          ...
          <FadeUpEffect tag="p">
            Enter AiDucator—a game-changing AI solution that takes the
            complexity out of the equation. With AiDucator, students and parents
            no longer need to sift through cluttered webpages or struggle with
            outdated search tools. Our AI-driven chatbot delivers instant,
            personalized responses to every query, ensuring that information is
            not just accessible but effortlessly delivered. For educational
            institutions, AiDucator is more than a tool—it's a necessity.
          </FadeUpEffect>
          <FadeUpEffect tag="p">
            ...
            frustrated, often missing out on vital details that could shape
            their educational journey. In a world where time is precious, the
